package com.danimed.agent_app.core.scheduling.presentation.infrastructure.api
...
class ScheduleApi(private val httpClient: HttpClient) {
    suspend fun getSchedules(doctorId: Int): Result<ApiRes<List<com.danimed.agent_app.core.scheduling.presentation.application.dto.res.ScheduleResponse>>> {
        return try {
            ...
            when (response.status) {
                HttpStatusCode.Unauthorized -> {
                    ...
                    val body = response.body<ApiRes<List<com.danimed.agent_app.core.scheduling.presentation.application.dto.res.ScheduleResponse>>>()
                    Result.success(body)
                }
            }
        } catch (e: Exception) {
